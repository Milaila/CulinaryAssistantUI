...
export class ThemeService {
  ...
  themes: ITheme[] = [
    ...
    { label: '', code: 'cyan-800-amber' },
    { label: '', code: 'cyan-900-yellow' },
    { label: '', code: 'cyan-900-lime' },
    { label: '', code: 'teal-700-light-green' },
